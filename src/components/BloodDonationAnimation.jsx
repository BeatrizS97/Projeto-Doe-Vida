      ...
      >
        ...
        <g id="blood-bag" transform="translate(-50, 0)">
          ...
          <g>
            ...
            />
            <ellipse cx="130" cy={160 - bloodHeight} rx="30" ry="5" fill="#991b1b" opacity="0.6">
          ...
          <text x="130" y="107" textAnchor="middle" fontSize="9" fill="#dc2626" fontWeight="bold">
            TIPO
          </text>
          <text x="130" y="122" textAnchor="middle" fontSize="14" fill="#dc2626" fontWeight="bold">
            O+
          </text>
