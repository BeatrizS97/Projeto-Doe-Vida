...
const BloodDonationAnimation = () => {
  ...
  return (
    <div className="relative w-full max-w-2xl h-[500px] flex items-center justify-center bg-gradient-to-br from-rose-50 to-red-50 rounded-2xl p-4 mx-auto overflow-hidden">
      {/* SVG - Bolsa e Tubo Flexível - ATRÁS DA IMAGEM DO BRAÇO */}
      <svg 
        viewBox="0 0 600 500" 
      ...
      >
        ...
        {/* Tubo FLEXÍVEL - Curva mais suave, conexão corrigida - Renderizado ANTES da bolsa para ficar atrás */}
        <g id="flexible-tube">
          {/* Tubo externo (cinza) */}
          <path
          ...
          {/* Escalpe realista no curativo - Garantindo opacidade total */}
          <g transform="translate(505, 240) rotate(90)">
            {/* Base do escalpe */}
            <ellipse cx="0" cy="0" rx="8" ry="6" fill="#e5e7eb" stroke="#9ca3af" strokeWidth="1.5" opacity="1"/>
            
            {/* Tampa azul */}
            <rect x="-6" y="-7" width="12" height="5" fill="#60a5fa" rx="2" opacity="1"/>
            
            {/* Agulha curta - entra no curativo */}
            <line x1="0" y1="1" x2="0" y2="12" stroke="#6b7280" strokeWidth="2" opacity="1"/>
            <polygon points="-1,12 1,12 0,14" fill="#374151" opacity="1"/>
            
            {/* Asas do escalpe */}
            <path d="M -6,-1 L -12,0 L -6,1" fill="#60a5fa" opacity="1"/>
            <path d="M 6,-1 L 12,0 L 6,1" fill="#60a5fa" opacity="1"/>
          </g>
          
        </g>

        {/* Bolsa de Sangue - Renderizada DEPOIS do tubo para cobrir o início */}
        <g id="blood-bag" transform="translate(-50, 0)">
          ...
          {/* Corpo da bolsa */}
          <path
            d="M 90,35 L 90,150 Q 90,165 105,165 L 155,165 Q 170,165 170,150 L 170,35 Z"            fill="#fee2e2"
            stroke="#dc2626"
            strokeWidth="2"
          />
      ...
      {/* IMAGEM DO BRAÇO - NA FRENTE DA ANIMAÇÃO PARA COBRIR A AGULHA, com opacidade reduzida para ver a agulha */}
      <div className="absolute bottom-0 right-0 w-[420px] h-[320px] z-20">
        <img 
      ...
      <div className="absolute bottom-6 left-0 right-0 text-center z-30">
        <p className="text-base font-bold text-rose-600 animate-pulse-slow drop-shadow-lg">
          Doando Vida ❤️
        </p>
      </div>
    </div>
