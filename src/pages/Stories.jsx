...
const Stories = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-white to-red-50 py-6 lg:py-8">
      <div className="container mx-auto px-4 lg:px-6">
        ...
        {/* Testimonials — mais compactos, tipografia legível */}
        <div
          ref={(el) => setRef(el, 1)}
            ...
            >
              <div className="flex flex-col sm:flex-row items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="relative">
                    <div className="absolute -left-2 -top-2 text-3xl text-rose-200 font-serif leading-none">"</div>
  ...
  {person.story}
                    ...
                    <div className="absolute -right-2 -bottom-2 text-3xl text-rose-200 font-serif leading-none rotate-180">"</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Gráfico de Tipos Sanguíneos — mantido intacto, sem alterações */}
        <div
          ref={(el) => setRef(el, 2)}
...
{/* ✨ Seção Redesign: "Como o Sangue Salva Vidas" — compacta + letras maiores */}
<div
  ref={(el) => setRef(el, 3)}
...
{/* Seção "Uma Doação, Múltiplos Usos" */}
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
    {bloodImpact.oneDonation.components.map((component, idx) => (
      ...
      >
        ...
        {/* Estados que Mais Precisam — compacto e claro */}
        <div
          ref={(el) => setRef(el, 4)}
          className="max-w-3xl mx-auto mb-6 lg:mb-8 opacity-0"
        >
          ...
          <div className="relative bg-gradient-to-br from-rose-600 via-red-600 to-rose-700 rounded-2xl shadow-xl p-5 text-white text-center overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <button 
                ...
                className="relative group/btn bg-white text-rose-600 px-6 py-2.5 rounded-full text-sm font-bold hover:bg-rose-50 transition-all shadow-md hover:shadow-lg transform hover:scale-105 overflow-hidden"
              >
